...
class Manager:
    ...
    def __parse_args(self) -> None:
        ...
        parser.add_argument('-f', '--float', metavar="Float Coordinates", default=False, choices=[True, False], dest="float", help="Can coordinates contain f-ploating numbers", type=bool)
